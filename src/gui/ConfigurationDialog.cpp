...
void ConfigurationDialog::createDialogContent()
{
	...
	connectBoolProperty(ui->showBookmarksButtonCheckBox,	"StelGui.flagShowBookmarksButton");
    	connectBoolProperty(ui->showBookmarksLocButtonCheckBox,	"StelGui.flagShowBookmarksLocButton");
...
void ConfigurationDialog::saveAllSettings()
{
	...
	conf->setValue("gui/flag_show_bookmarks_loc_button",		propMgr->getStelPropertyValue("StelGui.flagShowBookmarksLocButton").toBool());
